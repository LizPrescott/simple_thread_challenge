from app.constants import (
  FULL_DAY_HIGH, FULL_DAY_LOW, TRAVEL_DAY_HIGH, TRAVEL_DAY_LOW
)
...
def test_high_to_low_overlap():
    ...
    project_2_total = FULL_DAY_HIGH*5
    project_3_total = TRAVEL_DAY_LOW + FULL_DAY_LOW
...
def test_contiguous_projects():
    ...
    project_1_total = ((TRAVEL_DAY_LOW*2) + FULL_DAY_LOW)  # 195
    project_2_total = (TRAVEL_DAY_HIGH + (FULL_DAY_HIGH*2))  # 195
...
def test_travel_day_perfect_overlap():
    ...
    project_1_total = 0.0,
    project_2_total = TRAVEL_DAY_HIGH,
